...
export const experimentsRouter = router({
  ...
  getAll: protectedProcedure.query(async ({ ctx }) => {
    return await experimentGetters.getUserExperiments(ctx.user.id)
  }),
  ...
  getById: protectedProcedure
    ...
    .query(async ({ input, ctx }) => {
      return await experimentGetters.getExperimentById(input.id, ctx.user.id)
    }),
  ...
  getDetails: protectedProcedure
    .input(z.object({ id: z.string().uuid() }))
    .query(async ({ input, ctx }) => {
      return await experimentGetters.getExperimentDetails(input.id, ctx.user.id)
    }),
  ...
  create: protectedProcedure
    ...
    .mutation(async ({ input, ctx }) => {
      ...
      return await experimentSetters.createExperiment(experimentData)
    }),
  ...
  delete: protectedProcedure
    .input(z.object({ id: z.string().uuid() }))
    .mutation(async ({ input, ctx }) => {
      return await experimentSetters.deleteExperiment(input.id, ctx.user.id)
    }),
  ...
  sequences: router({
    ...
    create: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await experimentSetters.createSequence(input)
      }),
    ...
    update: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await experimentSetters.updateSequence(input.id, input.data)
      }),
    ...
    delete: protectedProcedure
      .input(z.object({ id: z.string().uuid() }))
      .mutation(async ({ input }) => {
        return await experimentSetters.deleteSequence(input.id)
      }),
  }),
  ...
  guideRnas: router({
    ...
    saveBatch: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await experimentSetters.saveGuideRnas(input.guideRnas)
      }),
    ...
    update: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await experimentSetters.updateGuideRna(input.id, input.data)
      }),
  }),
  ...
  offTargetSites: router({
    ...
    saveBatch: protectedProcedure
      ...
      .mutation(async ({ input }) => {
        return await experimentSetters.saveOffTargetSites(input.offTargetSites)
      }),
  }),
